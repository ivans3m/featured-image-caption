...
// Check if WordPress is available and all required components exist
if (typeof wp !== 'undefined' && wp.hooks && wp.element && wp.components && wp.blockEditor && wp.i18n) {
    ...
    // Fallback: Log error if WordPress components are not available
    console.warn('FoA Featured Image Caption: WordPress components not available');
}